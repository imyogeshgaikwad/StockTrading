  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        <h1 className="fs-2">To create ticket, select a relavant topic</h1>
        ...
        <div className="col-4 p-5 " style={{ textAlign: "left" }}>
          <h4 className="">
            <i class="fa-solid fa-circle-plus"></i> Kite
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2" }}>
            IPO{" "}
          </a>{" "}
      ...
      <div className="row p-5 ">
        ...
        <div className="col-4  " style={{ textAlign: "left" }}>
          <h4 className="">
            <i class="fa-solid fa-circle-plus"></i> Console
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2" }}>
            Portfolio{" "}
          </a>{" "}
        ...
        <div className="col-4 " style={{ textAlign: "left" }}>
          <h4 className="">
            <i class="fa-solid fa-circle-plus"></i> Coin
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2" }}>
            Mutual funds{" "}
          </a>{" "}
